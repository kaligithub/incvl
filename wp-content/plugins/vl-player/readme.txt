=== ViewLift Player for WordPress ===
Contributors: ViewLift Video
Tags: viewliftplayer, viewlift, player, viewliftplatform, video, media, html5
Requires at least: 4.3
Tested up to: 4.7.1
Stable tag: 1.6.0
License: GPLv3

Upload and embed videos with your ViewLift Player account to seamlessly integrate video into your WordPress website.
...
This plugin will give you the power to use videos, playlists, and players from your ViewLift Player account within WordPress. You will also be able to track the performance of your content with ViewLift Player’s dashboard analytics.


= Key Features =

* What it does:
    - Allows you to easily insert media (including playlists) into your website from your ViewLift Player account.
    - Allows you to place players from your ViewLift Player account into your website.


* What is does NOT do:
    - Replace the ViewLift Player dashboard
    - Allow you to create or manage players or media objects from within the plugin (these actions happen within the ViewLift Player dashboard)

* Additional features:
    - You may also sync WordPress-hosted media to your ViewLift Player account (as externally-hosted media)

[Sign up for a free ViewLift Player account!](http://www.jwplayer.com/pricing/)
...
3. Go the the plugins page, the ViewLift Player plugin should be visible.
...
1. Insert media from your ViewLift Player Account via the media library overlay or ...
...
= Does this plugin replace the old ViewLift Player Plugin for WordPress? =

Yes, it does. You cannot run both plugins at the same time. However, you can import your referenced media, your players and your playlists from the old plugin into your ViewLift Player account.
...
go to Settings > ViewLift Player and set the signing timeout to 0.
...
* Feature: Added option to disable syncing local content to your ViewLift Player account.
...
Please remember that this plugin replaces our old JW Platform and our old ViewLift Player for WordPress plugins and it should not be activated at the same time.
